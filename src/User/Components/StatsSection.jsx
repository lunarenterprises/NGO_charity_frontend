    ...
    return (
        <div className="relative px-4 -mt-16 md:px-12 z-20">
            <div className="grid grid-cols-1 gap-4 p-5 bg-black shadow-xl md:grid-cols-3 rounded-2xl max-w-7xl mx-auto border border-white/10">
                {/* Stat 1 */}
                <div className="flex flex-col items-center sm:flex-row sm:items-center gap-4 p-4">
                ...
                {/* Stat 2 */}
                <div className="flex flex-col items-center sm:flex-row sm:items-center gap-4 p-4 border-t md:border-t-0 md:border-l border-gray-800">
