...
const QuickDonationSuccess = ({ amount, transactionId }) => {
    ...
    return (
        <div className="min-h-screen overflow-y-auto overflow-x-hidden bg-black text-white flex flex-col justify-center pt-28 pb-12 relative">
            ...
            <div className="absolute bottom-0 left-0 w-[500px] h-[500px] bg-white/5 rounded-full -ml-64 -mb-64 blur-[120px] pointer-events-none"></div>
                ...
                <div className="flex flex-col lg:flex-row gap-12 lg:items-center">
                    ...
                    <div className="lg:w-1/2 animate-in slide-in-from-left duration-700">
                        <div className="flex items-center gap-3 mb-6">
                            <div className="w-10 h-10 rounded-full bg-green-500 flex items-center justify-center shadow-lg shadow-white/10">
                                <HiCheckCircle className="w-6 h-6 text-white" />
                            </div>
                            <div>
                                <span className="text-gray-400 font-black uppercase tracking-[0.2em] text-[10px] block">Donation Success</span>
                                <span className="font-bold text-xs uppercase tracking-widest text-green-400">
                                    Payment Confirmed
                                </span>
                            </div>
                        </div>
                        ...
                        <div className="space-y-4 text-base text-gray-400 font-medium leading-relaxed mb-8">
                            <p>
                                Your donation of <span className="text-white font-black text-lg">₹{parseFloat(amount).toLocaleString('en-IN')}</span> has been successfully processed.
...
export default QuickDonationSuccess;
